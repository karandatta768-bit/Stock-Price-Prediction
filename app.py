...
st.title("📈 Advanced Stock Trading Signal Predictor")
st.markdown("Use this professional dashboard to visualize historical stock data and predict the next day's BUY/SELL signal based on our trained machine learning model.")
...
if predict_button:
    ...
    if ticker:
        ...
        features = ["MA_5", "MA_10", "MA_20", "Volatility", "Return", "RSI", "MACD", "MACD_signal", "BB_high", "BB_low"]
        ...
        with col4:
            ...
            signal_color = "normal" if prediction == 1 else "inverse"
